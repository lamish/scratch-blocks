...
goog.provide('Blockly.FieldNumberDialog');
 ...
 */ 
    var eventType = this.isTouch ? 'touchstart' : 'click';
    del.addEventListener(eventType, () => {
        this.getInput(-1);
    })
    ...
    for (var i = 0; i < numSymbol.length; i++) {
        ...
        var eventType = this.isTouch ? 'touchstart' : 'click';
        var event = Blockly.bindEvent_(gridItem, eventType, this, captureClick(i));
    ...
    Blockly.bindEvent_(saveBtn, okEventType, null, (e) => {
